...
public class AlbumControllerTest {
    ...
    public void shouldReturnAlbumById() throws Exception{
        ...
        when(repo.findById(1L)).thenReturn(Optional.of(inAlbum));
